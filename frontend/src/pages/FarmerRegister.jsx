...
const FarmerRegister = () => {
  ...
  const RESEND_COOLDOWN = 60 // seconds (keep in sync with backend)
  ...
  const handleSubmit = async (values, { setSubmitting, setErrors }) => {
    try {
      ...
      setOtp('')
      setOtpError('')
      setResendSeconds(RESEND_COOLDOWN) // start cooldown immediately after sending OTP
  ...
  const closeModal = () => {
    // Allow closing, user can verify later from a separate flow if you add it
    setShowOtpModal(false)
  }
  ...
  return (
    <div className="min-h-screen bg-green-50 flex items-center justify-center">
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-green-700 text-center">👨‍🌾 Farmer Register</h2>
